<?php
        $type = $_GET["type"];
    if($type == "legislators") {
//        $response = file_get_contents('https://congress.api.sunlightfoundation.com/legislators?apikey=478638a5a0b643d3abcb4a8febfe2428&per_page=all');
...
//        $response = file_get_contents('https://congress.api.sunlightfoundation.com/committees?member_ids='.$bioguide_id.'&apikey=478638a5a0b643d3abcb4a8febfe2428&per_page=5');
        ...
        $bioguide_id = $_GET["bioguide_id"];
//        $response = file_get_contents('https://congress.api.sunlightfoundation.com/bills?sponsor_id='.$bioguide_id.'&apikey=478638a5a0b643d3abcb4a8febfe2428&per_page=5');
...
//        $response = file_get_contents('https://congress.api.sunlightfoundation.com/bills?apikey=478638a5a0b643d3abcb4a8febfe2428&per_page=50');
...
//        $response = file_get_contents('https://congress.api.sunlightfoundation.com/bills?history.active=false&apikey=478638a5a0b643d3abcb4a8febfe2428&per_page=50');
...
//        $response = file_get_contents('https://congress.api.sunlightfoundation.com/committees?apikey=478638a5a0b643d3abcb4a8febfe2428&per_page=all');
